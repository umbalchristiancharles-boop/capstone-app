...
.panel-header {
  ...
  border: 1px solid rgba(255, 229, 207, 0.8);
  border-radius: 16px;
  padding: 16px;
  box-shadow: 0 6px 18px rgba(75, 42, 6, 0.08);
}
...
.avatar {
  ...
  height: 56px;
  border-radius: 50%;
  background: linear-gradient(140deg, #5a2c0a, #7c2d12);
  color: #fff;
  display: grid;
  place-items: center;
  font-weight: 700;
...
/* Table and status styles (align with ManagerLogisticsPanel) */
.table-container {
  overflow-x: auto;
  margin-top: 8px;
}
